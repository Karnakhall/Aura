...
public:
	...
	FOnPlayerStatChanged OnAttributePointsChangedDelegate;	//Delegate broadcast when attributes points changed
	FOnPlayerStatChanged OnSpellPointsChangedDelegate;		////Delegate broadcast when spell points changed
